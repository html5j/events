...
Helper.show_sessions = function(sessions, speakers) {
    ...
    var template = [
        ...
        '  <tr>',
        '    <th scope="col">時間',
        '    <th scope="col">ルーム1A（<a href="https://www.youtube.com/watch?v=AuUES2f3bxM" target="_blank">ライブ</a>）<br>(1F)',
        '    <th scope="col">ルーム2A（<a href="https://www.youtube.com/watch?v=rHkEL0I_En4" target="_blank">ライブ</a>）<br>(2F)',
        '    <th scope="col">ルーム5A（<a href="https://www.youtube.com/watch?v=Y9-fnbeswUs" target="_blank">ライブ</a>）<br>(5F)',
        '    <th scope="col">ルーム5B（<a href="https://www.youtube.com/watch?v=Chdlf5PK7E0" target="_blank">ライブ</a>）<br>(5F)',
        '    <th scope="col">ルーム5C（<a href="https://www.youtube.com/watch?v=Oc8Wk7HYn0E" target="_blank">ライブ</a>）<br>(5F)',
        '    <th scope="col">ルーム6A（<a href="https://www.youtube.com/watch?v=wvggCAG5ttw" target="_blank">ライブ</a>）<br>(6F)',
        '</thead>',
