...
module.exports = {
  ...
  "go_otani": {
    "name": "大谷 剛",
    "affiliation": "株式会社サイバーエージェント",
    "affiliation_sub": "アメーバ事業本部ゲーム部門 インタラクションデザイナー",
  ...
  "yoshitaka_kasugai": {
    "name": "春日井 良隆",
    "affiliation": "日本マイクロソフト株式会社",
    "affiliation_sub": "デベロッパー&プラットフォーム統括本部",
  ...
  "hiroki_tani": {
    ...
    "description": "@@@株式会社サイバーエージェント Webディベロッパー$$$中小企業向けのアプリケーション開発、スタートアップでのスマートフォンサイト制作などを経て、現在はスマートフォンアプリの開発、テクニカルディレクションを担当している。 主な著書に「 魅せるiPhoneサイト 」「 スマートフォン制作の教科書（共著） 」。@@@http://inkdesign.jp$$$http://twitter.com/hiloki"
  },
  ...
  "brian_birtles": {
    "name": "Brian Birtles",
    "affiliation": "Mozilla Japan",
    "img_url": "img/speakers/brian_birtles.jpg",
  ...
  "jun_murai": {
    "name": "村井 純",
    "affiliation": "慶應義塾大学 環境情報学部長・教授 工学博士（慶應義塾大学・1987年取得）",
    "img_url": "img/speakers/jun_murai.jpg",
    "description": "@@@1984年国内のインターネットの祖となった日本の大学間ネットワーク「JUNET」を設立。$$$1988年インターネットに関する研究プロジェクト「WIDEプロジェクト」を設立し、2010年3月までその代表として、現在はファウンダーとして指導にあたっている。「日本のインターネットの父」と呼ばれ、海外では「Internet SAMURAI」とも呼ばれている。$$$1990年慶應義塾大学環境情報学部助教授を経て1997年より同教授。$$$1999～2005年慶應義塾大学SFC研究所所長、2005～2009年学校法人慶應義塾 常任理事、2009年より現職の環境情報学部長。$$$内閣 高度情報通信ネットワーク社会推進戦略本部（IT総合戦略本部）有識者本部員、内閣官房 情報セキュリティセンター 情報セキュリティ政策会議委員、社団法人情報処理学会フェロー、日本学術会議第20 期会員、現在は連携会員。@@@その他、各省庁委員会の主査や委員などを多数務め、国際学会などでも理事を務めるなどの活動をしている。"
  },
  "masakazu_muraoka": {
    "name": "村岡 正和",
  ...
  "shin_miyakawa": {
    "name": "宮川 晋",
    "affiliation": "NTTコミュニケーションズ株式会社",
    "img_url": "img/speakers/shin_miyakawa.jpg",
    "description": "@@@1992(平成4)年3月 東京工業大学 理工学研究科 情報工学専攻博士前期課程修了 修士(工学)$$$1995(平成7)年3月 東京工業大学 理工学研究科博士後期課程修了 博士(工学)$$$同4月 日本電信電話株式会社入社 ソフトウェア研究所配属$$$1997年3月より NTT Multimedia Communications Laboratories(米国シリコンバレー)$$$2002年4月より NTTコミュニケーションズ 先端IPアーキテクチャセンタ所属@@@NTT入社以来一貫して主にIPv6を中心としてインターネット技術の研究・開発・実用化に従事。$$$現在、NTTコミュニケーションズ株式会社 先端IPアーキテクチャセンタ担当部長としてインターネット技術開発のチームをリード。経営企画部サービス戦略担当兼務。$$$慶應義塾大学 SFC研究所 上席所員(訪問)および東京工業大学 非常勤講師。$$$論文、技術解説記事、RFC、著書、講演など。"
  },
  "ryuji_wakikawa": {
    "name": "湧川 隆次",
